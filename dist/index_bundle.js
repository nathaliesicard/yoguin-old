...
/***/ function(module, exports, __webpack_require__) {
	...
	var BackgroundVideo = __webpack_require__(160);
	// var routes = require('./config/routes');

	ReactDOM.render(React.createElement(BackgroundVideo, { src: './assets/sunset_waves.mov' }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classNames = _interopDefault(__webpack_require__(161));
	...
	var BackgroundVideo = function (_Component) {
	  ...
	  BackgroundVideo.prototype.render = function render() {
	    ...
	    return React__default.createElement('div', { className: videoClassNames, onClick: this.props.onClick }, React__default.createElement('video', babelHelpers.extends({ id: this.props.videoId, className: 'video-background' }, videoProps), videos), overlayElement, React__default.createElement('div', { className: 'video-content' }, this.props.children));
	  };
